 ...
 *
 *The original coordinate system is defined in
 *A. Blaauw, C. S. Gum, J. L. Pawsey, and G. Westerhout, ?The new
 *I.A.U. system of galactic coordinates (1958 revision),? Monthly Notes
 *of the Royal Astronomical Society, vol. 121, no. 2, pp. 123?131, 1960.
 *However, as documented in the IAU's function iauIcrs2g, the Galactic
 *coordinate system has been redefined in terms of more accurate modern
 *data.
 *
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if(numRow==3) {
        for(curVec=0;curVec<numVec;curVec++) {
            ...
            iauIcrs2g(curAz, curEl, &curAz, &curEl);
        ...
        for(curVec=0;curVec<numVec;curVec++) {
           ...
           //If a 2D vector was given, just get the azimuth and elevation.
            ...
            iauIcrs2g(curAz, curEl, curOutput, curOutput+1);
        }
    }
