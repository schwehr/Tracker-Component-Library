...
%Pascals is taken from
%Guide for the Use of the International System of Units, NIST Special
...
%That is also where the conversion from kilogram-force to Newtons was
%taken and where the definition of the technical atmosphere can be found.
%
