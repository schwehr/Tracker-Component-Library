 ...
 *
 *This is a wrapper for the function iauTtut1 in the International
 ...
 *[Jul1,Jul2]=TT2UT1(Jul1,Jul2);
 *or
 *[Jul1,Jul2]=TT2UT1(Jul1,Jul2,deltaT);
 *
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    retVal=iauTtut1(Jul1, Jul2, deltaT, &Jul1, &Jul2 );
    switch(retVal) {
        case -1:
