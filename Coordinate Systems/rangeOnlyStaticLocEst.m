...
%                        receivers (or transmitters) is necessary. If only
%                        the minimum number os provided, then there are 
%                        
...
%                   the estimate9s) based on the Cramér-Rao lower bound.
%
%The target localization algorithm is based on the spherical intersection
%method of
%Malanowski, M, and Kulpa, K., "Two methods for target localization in
%multistatic passive radar," IEEE Transactions on Aerospace and Electronic
%Systems, vol. 48, no. 1, pp. 572-580, Jan. 2012.
%where the Taylor series expansion covariance matrix for the estimate is
%also derived. The PCRLB covariance estimate is standard assuming additive
%Gaussian noise. 
%
