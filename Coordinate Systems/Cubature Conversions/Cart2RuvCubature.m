...
%                 receiver collocated.
%
%INPUTS:    z   A 3XN matrix of Cartesian points in global [x;y;z]
...
%
%OUTPUTS:    zRuv   The approximate mean of the PDF of the the measurement
%                   in bistatic [r;u;v] coordinates.
%            RRuv   The approximate 3 X 3 covariance matrix of the PDF of
%                   the bistatic [r;u;v] converted measurement.
%
...
[zRuv,RRuv]=calcMixtureMoments(cubPointsRUV,w);
end
