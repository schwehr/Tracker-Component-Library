...
%%SPHER2CARTCUBATURE Use cubature ointegration to approximate the moments
...
%                  single 3X3 matrix.
%              xi  A 3 X numCubaturePoints (for position-only) matrix of
%                  cubature points for the numeric integration. If this and
%                  the final parameter are omitted, then
%                  fifthOrderCubPoints is used to generate fifth-order 
%                  cubature points.
...
%
%OUTPUTS: zCart  The approximate mean of the PDF of the spherical-converted
%                measurement in [x;y;z] Cartesian coordiantes.
%         RCart  The approximate 3 X 3 covariance matrix of estimate.
%
