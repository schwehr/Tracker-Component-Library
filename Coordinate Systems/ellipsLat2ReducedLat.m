function reducedLat=ellipsLat2ReducedLat(ellipsLat,f)
%%ELLIPSLAT2REDUCEDLAT  Convert an ellipsoidal (geodetic) latitude to a
%                       reduced latitude, also known as a parameteric
%                       latitude. A parameteric latitude is an angle of
%                       elevation drawn from the center of a sphere whose
%                       radius is equal to the semi-major axis of the
%                       ellipsoid. The parametric latitude is the angle of
%                       the point on the sphere where a vertical line drawn
%                       from the major axis of the ellipse through the
%                       point on the ellipse intersects the sphere. This is
%                       a way of mapping an ellipsoid onto a sphere.
%
...
%
%OUTPUTS: reducedLat The reduced latitude ranging from -pi/2 to pi/2, for
%                    each ellipsoidal latitude,
%
...
%sphere.
%
%The inverse of this function is reducedLat2EllipsLat.
%
...
reducedLat=atan(sqrt(1-e^2)*tan(ellipsLat));
end
