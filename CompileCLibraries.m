...
mex('-v','-largeArrayDims','-U__STDC_UTF_16__','-outdir','./0_Compiled_Code/','-I./','-I./3rd_Party_Code/GeographicLib-1.43/include','-I./Container Classes/Shared C++ Code/','-I./Mathematical Functions/Shared C++ Code/','./Navigation/indirectGeodeticProb.cpp','./Mathematical Functions/Shared C++ Code/wrapRangeCPP.cpp','./3rd_Party_Code/GeographicLib-1.43/src/Geodesic.cpp','./3rd_Party_Code/GeographicLib-1.43/src/GeodesicExact.cpp','./3rd_Party_Code/GeographicLib-1.43/src/GeodesicLine.cpp','./3rd_Party_Code/GeographicLib-1.43/src/GeodesicLineExact.cpp','./3rd_Party_Code/GeographicLib-1.43/src/EllipticFunction.cpp','./3rd_Party_Code/GeographicLib-1.43/src/math.cpp','./3rd_Party_Code/GeographicLib-1.43/src/GeodesicExactC4.cpp');
...
if(ispc())
    ...
    for curCommand=1:numCommands
        ...
        if(~isempty(command))
            ...
            %The mex compile program must be in the path for anyting to compile
            %that wishes to externally call the matlab mex compiler.
...
elseif(ispc())%Windows
    ...
    system([cc, 'ais8.cpp']);
    system([cc, 'ais8_001_22.cpp']);
    system([cc, 'ais8_001_26.cpp']);
