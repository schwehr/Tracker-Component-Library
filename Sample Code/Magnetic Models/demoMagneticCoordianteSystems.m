%%DEMOMAGNETICCOORDSYS     This file shows how to use conversions to
...
%                          coordinate of each system from geodetic latitude
%                          at the reference epoch are displayed.
...
%Convert the positions to Cartesian coordiantes; assume that the points are
