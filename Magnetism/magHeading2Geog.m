function geoEastOfNorth=magHeading2Geog(points,PEastOfNorth,year,a,f)
...
%magnetic North would be the component of the the magnetic flux vector
...
for curPoint=1:numPoints
    ...
    vRot=rotateVector(B(:,curPoint),-u(:,3),PEastOfNorth(curPoint));
