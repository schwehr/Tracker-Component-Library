...
%            which has been sorted such that the elements are in increasing
...
%                   if key is not found. If this parameter is omitted, then
%                   the default is zero (the closest value).
