...
%
%The algorithm is taken from Chapter 15.4 of
%T. H. Cormen, C. E. Leiserson, R. L. Rivest, and C. Stein, Introduction
%to Algorithms, 2nd ed. Cambridge, MA: The MIT Press, 2001.
%but modified so that the sequence comes out in order and to deal with
%Matlab addressing things from 1 instead of 0.
%
