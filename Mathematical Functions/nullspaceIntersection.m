...
%matrix as described in Chapter 6.4.2 of 
%G. H. Golub and C. F. Van Loan, Matrix Computations, 4th ed.
%Baltimore: Johns Hopkins University Press, 2012.
%The lower computational-complexity algorithm listed in that chapter is not
%used, because it was noticed that determining the rank of the intermediate
%matrix C was difficult to do accurately. For example, when trying to find
%the intersection of [A;A], comparing singular values using a tolerance
