function [xList,uList]=RungeKCurvedAtTimes(xInit,uInit,times,aDyn,uFunc,deltaTMax,order)
...
%         deltaTMax The maximum allowable step size for propagation of
%                   the state. If this parameter is omitted, then Inf will
%                   be used, meaning that the steps are between the
%                   individual times.
