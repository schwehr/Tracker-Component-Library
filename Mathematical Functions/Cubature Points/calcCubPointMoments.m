...
%        h  A function handle for how the vector x is transformed. The
...
%           weights is generated using arbOrderCubPoints for fifth-order
%           points.
...
%           using arbOrderCubPoints for fifth-order points.
%
...
if(nargin<4)
    [xi,w]=arbOrderCubPoints(numDim,6);
end
