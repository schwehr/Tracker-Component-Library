...
%
%The solution comes from the general cubic formula given in
%Weisstein, Eric W. "Cubic Formula." From MathWorld
%--A Wolfram Web Resource. October 2014.
%http://mathworld.wolfram.com/CubicFormula.html
%and noting that if the arguments of the square roots are negative, the
%complex parts will cancel in the subsequent equation.
%
