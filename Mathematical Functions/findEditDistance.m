...
if(nargout>1)
    ...
    %Shrink the T to the actual length of the trace and reverse the
    %ordering so that it goes in the ordering of increasing i,j.
    T=fliplr(T(:,1:curEntry));
end
end
