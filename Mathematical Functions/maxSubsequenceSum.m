...
%Multiple approaches to the problem are described in 
%J. Bentley, "Algorithm design techniques," Communications of the ACM,
%vol. 27, no. 9, pp. 865-871, Sep. 1984.
%The algorithm has O(N) complexity as noted in its presentation in
%D. Gries, "A note on the standard strategy for developing loop invariants
%and loops," Department of Computer Science, Cornell University, Ithaca,
%NY, Tech. Rep. TR 82-531, Oct. 1982. [Online].
%
