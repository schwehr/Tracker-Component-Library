...
%
%If k<1, then the distribution has no mean.
%
...
%
%If k<2, then the distribution has no variance.
%
%October 2013 David F. Crouse, Naval Research Laboratory, Washington D.C.
...
%%PDF   Evaluate the inverse gamma distributin
%
...
%
%The distribution arises when estimating radar cross sections in
%W. Koch, Tracking and Sensor Fusion: Methodological Framework and Selected
%Applications. Berlin, Germany: Springer, 2014.
%
%October 2013 David F. Crouse, Naval Research Laboratory, Washington D.C.

    val=GammaD.PDF(1./x,k,1/beta);
end
    
function val=CDF(x,k,beta)
%%CDF Evaluate the cumulative distribution function of the
%                 inverse gamma distribution at desired points.
%
...
%                  >0.
%           beta  The scale parameter of the distribution, which is >0.
%
