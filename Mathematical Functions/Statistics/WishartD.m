...
%constant is given in Chapter 2.3.6 of 
...
%and 8 of
%M. L. Eaton, Multivariate Statistics: A Vector Space Approach, ser.
%Institute of Mathematical Statistics Lecture Notes-Monograph Series.
%Beachwood, Ohio: Institute of Mathematical Statistics, 2007, vol. 53.
%The Wishart distribution is just the outer product of DXnu normally
%generated random matrices, where each row is generated having zero-mean
