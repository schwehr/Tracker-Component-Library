...
%
%The implementations of the PDF of this class is taken from 
...
function x=rand(mu,Sigma,NLog)
%%RAND   Generate a hybird lognormal-normal random variable with a given
...
%
%OUTPUT: x   A sample of an xDimX1 joint lognormal-normal random variable.
%            The first NLog components are the lognormal components.
%
