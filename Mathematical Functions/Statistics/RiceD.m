...
%               evaluated at x.
%
%The PDF of the Rice distribution is given in Chapter 2.1.4 of 
%J. G. Proakis, Digital Communications. Ed. 4, Boston, MA:
%McGraw Hill, 2001.
%
...
%function as shown in Chapter 2.1.4 of
%J. G. Proakis, Digital Communications. Ed. 4, Boston, MA:
%McGraw Hill, 2001.
%
...
%          parameters.
%
%INPUTS:    N      If N is a scalar, then randRice returns an NXN matrix of
%                  random variables. If N=[M,N1] is a two-element row 
%                  vector, then randRice returns an MXN1 matrix of random
%                  variables.
%           s      The noncentrality parameter of the distribution.
%           sigma  The scale parameter of the distribution.
%
