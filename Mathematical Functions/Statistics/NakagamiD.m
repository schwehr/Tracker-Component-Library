...
%%PDF          Evaluate the PDF of the Nakagami-m probability distribution
...
%September 2013 David F. Crouse, Naval Research Laboratory, Washington D.C.
    ...
    val=(2/gamma(m))*((m/Omega)^m)*x.^(2*m-1).*exp(-(m/Omega)*x.^2);
end 
...
%               given parameters.
%
%INPUTS:    N      If N is a scalar, then rangNakagami returns an NXN 
%                  matrix of random variables. If N=[M,N1] is a two-element  
%                  row vector, then randNakagami  returns an MXN1 matrix of 
%                  random variables.
%           m      The shape parameter of the distribution.
%           Omega  The spread parameter of the distribution.
%
