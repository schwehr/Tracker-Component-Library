...
%               obtain the lognormal distribution. If the PDF is
...
%%VAR   Obtain the coveriance matrix of the lognormal distribution (the
%       variance if scalar).
%
%INPUTS:    mu  The mean of the normal distribution that is transformed to
%               obtain the lognormal distribution. If the PDF is
...
%%PDF         Evaluate a scalar or multivariate lognormal PDF at a
...
%           mu  The mean of the scalar normal distribution that is
%               transformed to obtain the lognormal distribution.
%          var  The variance of the Gaussian PDF that is
...
function x=rand(mu,Sigma)
%%RAND   Generate a multivariate lognormal random variable with a given
%        mean vector and covariance matrix.
%
%INPUTS: mu     The mean of the normal distribution that is
%               transformed to obtain the lognormal distribution.
%        Sigma  The variance or covariance matrix of the Gaussian PDF that
%               is transformed to get the lognormal distribution.
%
%OUTPUT: x   A sample of an xDimX1 lognormal random variable.
%
