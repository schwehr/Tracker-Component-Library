...
%            from the x-axis or x=[x;y;xdot;ydot;at] where at is the the
...
%            target state is either x=[x;y;xdot;ydot;omega;al] where omega
...
%                         acceleration. This model will produce NaNs when
%                         the velocity is very close to zero.
...
%June 2015 David Crouse, Naval Research Laboratory, Washington D.C.
