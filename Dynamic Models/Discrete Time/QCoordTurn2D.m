...
%           Cartesian coordiantes. Note that Q is singular, due to the
...
%
%The corresponding transition matrix is given by the function FCoordTurn2D.
%The corresponding continuous-time functions are aCoordTurn2D and
...
switch(length(x))
    case 5%There is no linear acceleration.        
        ...
        G(5)=G(5)*sigmaTurn;
        Q=G*G';
    case 6%There is linear acceleration.
