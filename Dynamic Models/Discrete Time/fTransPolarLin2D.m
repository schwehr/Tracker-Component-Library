...
%D. Laneuville, "Polar versus Cartesian velocity models for maneuvering
%target tracking with IMM," in Proceedings of the IEEE Aerospace
%Conference, Big Sky, MT, 2?9 Mar. 2013.
%
%The discretized model is inspired from a discussion in 
...
%on the principles in Chapter 6 of
...
%where a matrix exponential is used.
%
