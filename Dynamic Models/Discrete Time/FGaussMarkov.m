function F=FGaussMarkov(T,x,tau,order)
...
%model is in Equation 8.2.3-9 in Chapter 8.2.3 of
...
%In Chapter 8.2.3 of the aforementioned book also states that a typical
%value of tau for a slowly turning aircraft is 20s, and is 5s for an
%evasive maneuver.
...
%We will do the 1D values and then spread them across all fo the
%dimensions.
