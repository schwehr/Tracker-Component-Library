function F=FVanKeuk(T,x,tau,numDim)
...
%
%Van Keuk's dynamic model is described in
%Chapter 2.2.1
%W. Koch,Tracking and Sensor Data Fusion: Methodological Framework and
%Selected Applications. Heidelberg, Germany: Springer, 2014.
%and is described in slightly more detail in
%G. van Keuk, "Zielverfolgung, basierend auf dem Kalman-Bucy-filter,"
%Applied Informatics, vol. 14, no. 7, pp. 302?308, 1972.
%The model is essentially a direct-discrete-time version of Singer's
%dynamic model.
%
%When describing Singer's dynamic model, Chapter 8.2.3 of
...
%states that a typical value of tau for a slowly turning aircraft is 20s,
%and is 5s for an evasive maneuver. Presumably the same applies when using
%van Keuk's model.
%
