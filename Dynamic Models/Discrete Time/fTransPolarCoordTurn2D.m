...
%transition Equation after equation 1b in  
...
%which comes from the initial derivation in
...
%where a different definition of heading direction is used.
%Note that the order of the components in the state here is different than
%the ordering of the components in Blackman's paper. Also, Blackman's paper
%does not consider linear acceleration terms.
%
%Despite the form of the transition matrix without a linear acceleration
%term, the result is mathematically equivalent to equation 75 in
