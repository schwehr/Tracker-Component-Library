...
%describes how the covariance matrix for a linear dynamic model is found.
%This function just generalized the procedure to an arbitrary polynomial
%order. Equations for the generalization are given in Appendix A of
