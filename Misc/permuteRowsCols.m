...
%                 using the notation A(sigma,tau), where sigma and twu are
...
%After being modified as the book actually gave an algorithm for the
%inverse permutation, whereas one generally ewants it for the actual
%permutation.
%
