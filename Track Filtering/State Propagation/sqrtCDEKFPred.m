...
%               continuous-time stochastic diferential equation. This uses
...
%               forward using the RKAdaptiveOverRange function, an explicit
%               Runge-Kutta method, which can take a number of options.
%
...
%method described in:
%P. Frogerais., J. Bellanger, and L. Senhadji. "Various ways to compute the
%continuous-discrete extended Kalman filter," IEEE
%Transactions on Automatic Control, vol. 57, no. (4), pp. 1000-1004, 2012
%Other methods in this paper are criticized in Section III of:
%G. Y. Kulikov and M. V. Kulikova. "Accurate numerical implementation of
%the continuous-discrete extended Kalman filter," IEEE Transactions on
%Automatic Control, vol. 59, no. 1, pp. 273-279, Jan. 2014.
%
%Parts of the calculation for the derivative of the square root state
%covariance matrix are taken from Section VI of "Basic Tracking Using
%Nonlinear Continuous-Time Dynamic Models" by David F. Crouse. 
%
