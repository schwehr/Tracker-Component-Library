...
%
%INPUTS: yPrev      The information state at the previous time-step. The
...
%The matrix G in the paper is omitted, since any control input can be
%pre-multipled by the matrix. The implied discrete-time dynamic model is
...
%
%More information on information filtering is given in Chapter 7.2 of
