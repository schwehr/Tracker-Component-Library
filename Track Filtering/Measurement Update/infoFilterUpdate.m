...
%
%INPUTS: yPred      The predicted information state. The information state
%                   is the inverse covariance matrix times the target
%                   state.
%        PInvPred   The inverse of the predicted state covariance matrix.
...
%given here is from the flow chart given in Appendix H of
