...
%%ESRIFUPDATE      Perform the measurement update step in an extened
...
%                  measurement difference must to be restricted to a
...
%Psiaki, Mark L., et al. "ALEXIS spacecraft attitude reconstruction with 
%thermal/flexible motions due to launch damage." Journal of Guidance, 
%Control, and Dynamics 20.5 (1997): 1033-1041.
%which implements an extended version of the square root information filter
