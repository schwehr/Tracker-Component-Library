...
%However, it has been implemented without the additions to allow for
%noise-free measurement components. The same steps are described in the
%beginning of
%G. J. Bierman and M. R. Belzer, "A decentralized square root information
%filter/smoother," in Proceedings of the 24th Conference on Decision and
%Control, Fort Lauderdale, FL, Dec. 1985, pp. 1902-1905.
%though this implementation doe snot consider a decentralized application.
%
