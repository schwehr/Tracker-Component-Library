function [xUpdate,PUpdate,innov,Pzz]=EKFUpdate(xPred,PPred,z,R,h,HJacob,numIter,HHessian,innovTrans,measPredTrans,stateDiffTrans,stateTrans)
%%EKFUPDATE Perform the measurement update step in the first- or second-
%           order Extended Kalman Filter (EKF).
%
