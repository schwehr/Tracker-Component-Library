function [xUpdate,SUpdate,innov,Szz]=sqrtEKFUpdate(xPred,SPred,z,SR,h,HJacob,innovTrans,stateTrans)
...
%used for improved numerical stability.
...
%with a flow chart given in Appendix G.
%
