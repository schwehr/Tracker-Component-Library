...
%               at time k with no process noise. Alternatively, if all of
%               the state transition matrices are the same, one can just
%               pass a single xDim X xDim matrix. Note that all of the F
...
%squares algorithm of Chapter 3.4 of
...
%The covariance provided is the covariance associated with the algorithm.
%The measurement matrices for the propagated state as well as the
%transition matrices for the propagated state are taken as derived in
%Section 3.3.2 of
