function [ySqrtEst, PInvSqrtEst]=sqrtInfoSmoother(ySqrtPred,PInvSqrtPred,z,u,H,F,SR,SQ,Gamma,kD)
%%SQRTINFOSMOOTHER Run the square root information smoother for linear
...
%smoother that is described in the book
%G. J. Bierman, "Factorization Methods for Discrete Sequential Estimation.
%Academic Press, New York, 1977.
%The forward pass steps can be found in Chapter IV, and the backwards
%smoother in Chapter X.
%
