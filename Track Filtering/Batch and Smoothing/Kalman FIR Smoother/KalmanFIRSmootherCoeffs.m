...
%Note that the orderings of the products of the D terms in the code below
%are very important. This was not made clear in the paper. The matrix G in
%the paper is omitted, since any control input can be pre-multipled by the
%matrix.
%
