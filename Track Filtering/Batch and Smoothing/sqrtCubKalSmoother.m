...
%               averaged.
%
%OUTPUTS:xSmooth  The xDimXN smoothed state estimates at all steps if kD
%                 is not provided or the xDimX1 smoothed information state
%                 estimate at step kD if kD is provided.
%        SSmooth  The square root covariance matrices associated with the
%                 smoothed state estimates. This is xDimXxDimXN for the
%                 whole batch if kD is not provided and is xDimXxDim if kD
%                 is provided.
%
...
%
%The smoothing algorithm is taken from
%I. Arasaratnam and S. Haykin, “Cubature Kalman smoothers,” Automatica,
