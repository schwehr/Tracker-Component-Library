function [xSmooth,PSmooth,xUpd,PUpd]=EKalmanSmoother(xInit,PInit,z,h,HJacob,f,FJacob,R,Q,kD,numIter)
%%EKALMANSMOOTHER Run the extended forward-backward Kalman smoother for
%                 nonlinear dynamic and measurement models on a batch of
...
%
%The smoothing iteration algorithm is taken from Section III of
%L. A. Johnston and V. Krishnamurthy, “Derivation of a sawtooth iterated
%extended Kalman smoother via the AECM algorithm,” IEEE Transactions on
%Signal Processing, vol. 49, no. 9, pp. 1899–1909, 2001
%This provides an algorithm to iterate the smoothed state, but not the
