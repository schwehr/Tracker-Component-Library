...
%Cramér-Rao bound for target tracking in clutter," IEEE Transactions on
%Aerospace and Electronic Systems, vol. 47, no. 2, pp. 1481-1482,
%Apr. 2011.
%which simplifies the algorithm of
%X. Zhang, P. Willett, and Y. Bar-Shalom, "Dynamic Cramér-Rao bound for
...
%P. Stinco, M. S. Greco, F. Gini,and A.Farina, "Posterior Cramér-Rao lower
...
%P. Tichavský, C. H. Muravchik, and A. Nehorai, "Posterior Cramér-Rao
