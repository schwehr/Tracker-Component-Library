...
%one is discussed in
%Y. Boers and H. Driessen, "Modified Riccati equation and its application
%to target tracking," IEE Proceedings Radar, Sonar and Navigation,
%vol. 153, no. 1, pp. 7-12, Feb. 2006.
%However, they do not explicitely write out the posterior form. The
%posterior recursion goes from P_{k|k} to P_{k+1|k+1}. This stands in
%contrast to the prior Riccati equation, which expresses the transition
%from P_{k|k-1} to P_{k+1|k}.
%
